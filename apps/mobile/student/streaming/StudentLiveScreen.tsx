/**
 * StudentLiveScreen.tsx
 * ─────────────────────────────────────────────────────────────────────────────
 * Student-facing live session screen.
 * Provider routing is fully delegated to MeetingPlayerFactory.
 * ─────────────────────────────────────────────────────────────────────────────
 */
...
export const StudentLiveScreen: React.FC<Props> = ({ provider, payload }) => {
  ...
  return (
    <View style={styles.container}>
      <SessionHeader title={payload?.classTitle || 'Live Session'} />
      ...
      />
      <BottomSheetWorkspace capabilities={['canChat']} isLive={isLive} />
    </View>
  );
};
