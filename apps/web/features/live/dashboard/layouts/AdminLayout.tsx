...
// Plugins are now registered in Stubs.tsx (or a central bootstrapper)
import { 
  ResourcesWorkspace, AttendanceWorkspace, AIWorkspace, 
  ParticipantsWorkspace, TimelineWorkspace 
