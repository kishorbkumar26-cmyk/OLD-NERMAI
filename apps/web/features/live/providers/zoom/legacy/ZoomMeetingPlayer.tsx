/**
 * @deprecated ZoomMeetingPlayer (Component View embedded iframe)
 *
 * This implementation used the Zoom Meeting Embedded SDK (Component View)
 * inside an iframe. It was replaced by the managed popup window architecture
 * in ZoomMeetingPage.tsx and MeetingLauncherService.
 *
 * Keep this file as a rollback path. If a future Zoom SDK version resolves
 * the Component View render issues, this can be restored from here.
 *
 * DO NOT import this from any active feature code.
 */
